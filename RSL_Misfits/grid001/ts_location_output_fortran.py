...
caseid = "grids_compr_peltier_digitized_FN" #"grids_compr_engelhart2015" # "grids_compr_engelhart2012"  #"grids_compr_Vacchi"  #"grids_compr_peltier_global_hudsonbay_2000km"  #"grids_compr_peltier_global_NA_age_5k" #"grids_compr_peltier_digitized_NA_hudsonbay"  #"grids_compr_peltier_global_hudsonbay_coast"  #"grids_compr_peltier_global_hudsonbay_500km"  #"grids_compr_peltier_digitized_NA"  #"grids_compr_peltier_NA_random_select" #"'grids_compr_peltier_NA_sorted_select1'"#'grids_compr_peltier_NA_ALL' #'grids_compr_peltier_digitized'  #"grids_compr_lambeck_NA_ALL" #'grids_compr_lambeck_farfield' #'grids_compr_lambeck_NA' #'grids_compr_peltier_rsl' #'grids_compr_lambeck_farfield' #'grids_compr_peltier_digitized'#'grids_compr_lambeck_NA' #'grids_compr_lambeck_farfield' #'grids_compr'
...
#data_locations = np.loadtxt('/home/khuan/gridresearch_results_ANU_batch/RSL_site_location_Lambeck_NA_all.txt') 
#data_locations = np.loadtxt('/home/khuan/gridresearch_results_ANU_batch/RSL_site_location_selected_Lambeck_NA.txt') 
#data_locations = np.loadtxt('/home/khuan/gridresearch_results_ANU_batch/RSL_site_location_digitized_selected.txt') 
...
#data_locations = np.loadtxt("/home/khuan/gridresearch_results_ICE6G_batch/RSL_site_location_Engelhart_edit.txt")
