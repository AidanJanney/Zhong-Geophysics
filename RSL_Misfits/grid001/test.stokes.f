...
c
      ...
      open (88,file='in.stokes.ice5',status='unknown')
...
c      do 1 nobs=1,nepochs
      do 1 nobs=nepochs,nepochs
...
c  turn off the sle iteration, read in the original ice load
      close (39)
      open (49,file=name,status='unknown')
c      open(49,file='final_load.ice6g',status='unknown')
      endif
