...
def calc_RMS_grid(idGridFile):
	...
	for idx_site in range(len(selectedUTKEY)):
	    ...
	    #err[idx_site] = np.mean(((rslDataAtSite - rslModelAtSite[idx_rslModel]) / rslDataError)**2)*Jacobi[idx_site]
            #err[idx_site] = np.mean(((rslDataAtSite - rslModelAtSite[idx_rslModel]) / rslDataError)**2)
            #rslDataAtSite[rslDataAtSite==0.0] = 0.5
            #err[idx_site] = np.mean(((rslDataAtSite - rslModelAtSite[idx_rslModel]) / rslDataAtSite)**2)
...
#np.savetxt("ICE6G_rms_Engelhart_2015_edit.txt", rms)
#np.savetxt("ICE6G_rms_Engelhart_2015_edit_timeErr.txt", rms)
np.savetxt("ICE6G_rms_Engelhart_2012_edit_timeErr.txt", rms)
#np.savetxt("ICE6G_rms_Engelhart_2012_edit_norm.txt", rms)
#np.savetxt("ICE6G_rms_Engelhart_2015_edit_norm.txt", rms)
