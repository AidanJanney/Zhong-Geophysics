...
def calc_RMS_grid(idGridFile):
	...
	fnGridFile = "RSL_ICE6G_grids_compr_engelhart2015.txt"
	#fnGridFile = "RSL_ICE6G_grids_compr_engelhart2012.txt"
	...
	fnRSL = 'Engelhart et al_QSR_2015_Appendix1_edit_extract.xlsx'
	#fnRSL = 'engelhart_horton_QSR2012_spreadsheet_edit_extracted.xlsx'
	...
	data = pandas.read_excel(path.join(ddirRSL, fnRSL))
        UTKEY = data["Region"].values
        RSL = data["RSL"].values
        RSLERR = data["RSL Error"].values
        RSLMIN = RSLERR
        RSLMAX = RSLERR
        AGE = data["Age"].values
        AGEERR = data["Age error"].values
        AGEMIN = AGEERR
        AGEMAX = AGEERR
        ...
        data_locations = np.loadtxt("/home/khuan/gridresearch_results_ICE6G_batch/RSL_site_location_Engelhart_2015_edit.txt")
        #data_locations = np.loadtxt("/home/khuan/gridresearch_results_ICE6G_batch/RSL_site_location_Engelhart_edit.txt")   # 2012 
	...
	fnUTKEY = 'Sitename_Engelhart_2015_edit.txt'
	#fnUTKEY = 'Sitename_Engelhart_edit.txt'
	...
	#errGlobalMean = np.mean(np.sqrt(err))
...
#np.savetxt("ICE6G_rms_Vacchi_edit.txt", rms)
#np.savetxt("ANU_rms_Engelhart_2015_edit.txt", rms)
#np.savetxt("ANU_rms_Engelhart_2012_edit.txt", rms)
...
#np.savetxt("ICE6G_rms_presentday_Engelhart_2015_594.txt", rms, fmt="%0.2f  %0.2f  %6.3f")
#np.savetxt("ICE6G_rms_presentday_Engelhart_2012_594.txt", rms, fmt="%0.2f  %0.2f  %6.3f")
#np.savetxt("ICE6G_m1_rms_alltimesteps_Engelhart_2012_594.txt", rms, fmt="%0.2f  %0.2f  %6.3f  %6.3f     %6.3f  %6.3f   %6.3f  %6.3f")
#np.savetxt("ICE6G_m1_rms_alltimesteps_Engelhart_2015_594.txt", rms, fmt="%0.2f  %0.2f  %6.3f  %6.3f     %6.3f  %6.3f   %6.3f  %6.3f")
np.savetxt("ICE6G_vm5a_rms_alltimesteps_Engelhart_2015.txt", rms, fmt="%0.2f  %0.2f  %6.3f  %6.3f     %6.3f  %6.3f   %6.3f  %6.3f")
