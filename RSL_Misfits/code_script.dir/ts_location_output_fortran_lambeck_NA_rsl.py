...
caseid = 'grids_compr_lambeck_NA' #'grids_compr_peltier_rsl' #'grids_compr_lambeck_farfield' #'grids_compr_peltier_digitized'#'grids_compr_lambeck_NA' #'grids_compr_lambeck_farfield' #'grids_compr'
