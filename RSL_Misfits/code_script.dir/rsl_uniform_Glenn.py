...
ddir="/home/khuan/gridresearch_results_ANU_batch/ANU/XYZ"  #'../ANU/XYZ' #'../Maine_Glenn/4Shijie/XYZ'
ddir_ocean="/home/khuan/gridresearch_results_ANU_batch/ocean_anu120p83"#'../ocean_anu120p83'  #'../Maine_Glenn/4Shijie/ocean_ice6g120p55'
...
A00 = np.zeros(n_files)*np.nan
I00 = np.zeros(n_files)*np.nan
...
#for count in [49,50]:
	...
	A00[count] = ylms['clm'][0,0]

	# calculate [I]_00
	ylms = gen_clms(ih,lon,lat,lmax,lmax)
	I00[count] = ylms['clm'][0,0]
	...
	#pdb.set_trace()
	rsl[count] = (-893./1027.*I00[count] - NUO00)/A00[count]
        ice_volume[count] = re**2*I00[count]*np.sqrt(4*M_PI) 

        rsl_eustatic[count] = (-893./1027.*I00[count])/A00[count]
# svae text files
if 1:
...
if 1:
        otxt4 = 'A00_ANU.txt'
        np.savetxt(otxt4, A00, fmt='%14.5e  ')

if 1:
        otxt5 = 'I00_ANU.txt'
        np.savetxt(otxt5, I00, fmt='%14.5e  ')
