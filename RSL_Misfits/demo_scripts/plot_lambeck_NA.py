'''
Plot the RSL data for NA sites from Lambeck
files:
        ../../RSL_OBS/RSL_dataset_Lambeck_NA/Lambeck_etal_2014_PNAS_supp_edit.xlsx
'''
...
ddirRSL = '../../RSL_OBS/RSL_dataset_Lambeck_NA/'
fnRSL = 'rsl_dataset_lambeck_NA.xlsx'
...
for i in range(len(sitename_unique)):
    ...
    title = sitename_unique[i] + ' (lat, lon) = (' + str(lat_site) + ', ' + str(lon_site) + ')  2 sigma error'
